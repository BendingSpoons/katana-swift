...
//    XCTAssertEqual(newState.isEmpty, false)
//  }
//
//  
...
//    XCTAssertEqual(newState.isAuthenticated, false)
//    XCTAssertEqual(newState.username, nil)
//    XCTAssertEqual(newState.isEmpty, nil)
//  }
//  
...
//    let fourthState = AuthenticationReducer.reducer(action: logoutAction, state: thirdState)
...
//    XCTAssertEqual(fourthState.token.isEmpty, nil)
//  }
}
